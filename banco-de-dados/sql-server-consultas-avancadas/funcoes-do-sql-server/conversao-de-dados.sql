...
SELECT 'O Cliente ' + NOME + ' faturou ' + CONVERT(VARCHAR, ([QUANTIDADE] * COUNT(1)) FROM [NOTAS FISCAIS]

/* Queremos construir um SQL cujo resultado seja, para cada cliente: **"O cliente João da Silva 
faturou 120000 no ano de 2016". Somente para o ano de 2016. */
