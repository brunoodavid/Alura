...
BEGIN
	...
	SET @VENDEDOR = [dbo].[EntidadeAleatoria]('VENDEDORES')
	...
	BEGIN
		SET @PRODUTO = [dbo].[EntidadeAleatoria]('PRODUTOS')
		SELECT @AUX_PRODUTO = COUNT(*) FROM @LISTAPRODUTOS WHERE PRODUTO = @PRODUTO
		IF @AUX_PRODUTO = 0
		BEGIN
...
EXEC CriaNotaFiscal @DATANOTA = '20160203'