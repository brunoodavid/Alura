...
CREATE PROCEDURE [dbo].[TrataErroZeroTry] @CPF VARCHAR(12), @ANO INT, 
@MENSAGEM VARCHAR(50) OUTPUT, @DENOMINADOR INT
AS
BEGIN
	BEGIN TRY
...
@MENSAGEM VARCHAR(30) OUTPUT
AS 
BEGIN
	BEGIN TRY
		INSERT INTO [TABELA DE VENDEDORES] (MATRICULA, NOME, [PERCENTUAL COMISSÃO], [DATA ADMISSÃO], [DE FERIAS],
		BAIRRO)
...
EXEC InclusaoVendedor02 '00238','Pericles Alves',0.11,'20160821',0,'Santo Amaro', 
